defmodule Api.Products.Product do
  ...
  def changeset(product, attrs) do
    product
    |> cast(attrs, [:skuinfo, :mfgid, :short_description, :manufacturer_id, :manufacturer_name, :distributor_list, :last_update, :user_id, :gtin, :category_list, :external_ids_list, :category_external_ids_list, :non_taxable, :not_for_sale, :hide, :gift_certificate, :home_special, :category_special, :non_searchable, :gift_wrap_item, :ship_cost, :weight, :height, :width, :depth, :self_ship, :free_shipping, :reward_points, :redeem_points, :disable_rewards, :stock_alert, :reorder_quantity, :in_stock_message, :out_of_stock_message, :back_order_message, :inventory_control, :warehouse_location, :warehouse_bin, :warehouse_aisle, :warehouse_custom, :description, :keywords, :extra_field_1, :extra_field_2, :extra_field_3, :extra_field_4, :extra_field_5, :extra_field_6, :extra_field_7, :extra_field_8, :extra_field_9, :extra_field_10, :extra_field_11, :extra_field_12, :extra_field_13, :feature_list, :plugin_list, :sample_enable, :sample_name, :sample_skuprefix, :sample_price, :sample_weight, :review_average, :review_count, :main_image_file, :main_image_caption, :thumbnail_file, :media_file, :additional_image_file_2, :additional_image_caption_2, :additional_image_file_3, :additional_image_caption_3, :additional_image_file_4, :additional_image_caption_4, :image_gallery_list, :option_set_list, :advanced_option_list, :related_product_list, :up_selling_item_list, :discount_list, :do_not_use_category_options, :date_created, :listing_template_id, :listing_template_name, :login_required_option_id, :login_required_option_name, :login_required_option_redirect_to, :allow_access_customer_group_id, :allow_access_customer_group_name, :rmamax_period, :canonical_url, :tax_code, :display_text, :minimum_quantity, :maximum_quantity, :allow_only_multiples, :allow_fractional_quantity, :quantity_options, :group_options_for_quantity_pricing, :apply_quantity_discount_to_options, :enable_make_an_offer_feature, :minimum_acceptable_offer, :price_level_1, :price_level_1_hide, :price_level_2, :price_level_2_hide, :price_level_3, :price_level_3_hide, :price_level_4, :price_level_4_hide, :price_level_5, :price_level_5_hide, :price_level_6, :price_level_6_hide, :price_level_7, :price_level_7_hide, :price_level_8, :price_level_8_hide, :price_level_9, :price_level_9_hide, :price_level_10, :price_level_10_hide, :buy_button_link, :product_link, :title, :custom_file_name, :redirect_link, :meta_tags, :special_instructions, :assign_key, :re_use_keys, :serial_list, :eproduct_list])
    |> validate_required([:skuinfo, :mfgid, :short_description, :manufacturer_id, :manufacturer_name, :distributor_list, :last_update, :user_id, :gtin, :category_list, :external_ids_list, :category_external_ids_list, :non_taxable, :not_for_sale, :hide, :gift_certificate, :home_special, :category_special, :non_searchable, :gift_wrap_item, :ship_cost, :weight, :height, :width, :depth, :self_ship, :free_shipping, :reward_points, :redeem_points, :disable_rewards, :stock_alert, :reorder_quantity, :in_stock_message, :out_of_stock_message, :back_order_message, :inventory_control, :warehouse_location, :warehouse_bin, :warehouse_aisle, :warehouse_custom, :description, :keywords, :extra_field_1, :extra_field_2, :extra_field_3, :extra_field_4, :extra_field_5, :extra_field_6, :extra_field_7, :extra_field_8, :extra_field_9, :extra_field_10, :extra_field_11, :extra_field_12, :extra_field_13, :feature_list, :plugin_list, :sample_enable, :sample_name, :sample_skuprefix, :sample_price, :sample_weight, :review_average, :review_count, :main_image_file, :main_image_caption, :thumbnail_file, :media_file, :additional_image_file_2, :additional_image_caption_2, :additional_image_file_3, :additional_image_caption_3, :additional_image_file_4, :additional_image_caption_4, :image_gallery_list, :option_set_list, :advanced_option_list, :related_product_list, :up_selling_item_list, :discount_list, :do_not_use_category_options, :date_created, :listing_template_id, :listing_template_name, :login_required_option_id, :login_required_option_name, :login_required_option_redirect_to, :allow_access_customer_group_id, :allow_access_customer_group_name, :rmamax_period, :canonical_url, :tax_code, :display_text, :minimum_quantity, :maximum_quantity, :allow_only_multiples, :allow_fractional_quantity, :quantity_options, :group_options_for_quantity_pricing, :apply_quantity_discount_to_options, :enable_make_an_offer_feature, :minimum_acceptable_offer, :price_level_1, :price_level_1_hide, :price_level_2, :price_level_2_hide, :price_level_3, :price_level_3_hide, :price_level_4, :price_level_4_hide, :price_level_5, :price_level_5_hide, :price_level_6, :price_level_6_hide, :price_level_7, :price_level_7_hide, :price_level_8, :price_level_8_hide, :price_level_9, :price_level_9_hide, :price_level_10, :price_level_10_hide, :buy_button_link, :product_link, :title, :custom_file_name, :redirect_link, :meta_tags, :special_instructions, :assign_key, :re_use_keys, :serial_list, :eproduct_list])
  end
end

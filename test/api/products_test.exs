defmodule Api.ProductsTest do
  ...
  describe "products" do
    ...
    test "create_product/1 with valid data creates a product" do
      ...
      assert product.apply_quantity_discount_to_options ==
               "some apply_quantity_discount_to_options"
      ...
      assert product.group_options_for_quantity_pricing ==
               "some group_options_for_quantity_pricing"
    ...
    test "update_product/2 with valid data updates the product" do
      ...
      assert product.login_required_option_redirect_to ==
               "some updated login_required_option_redirect_to"
      ...
      assert product.allow_access_customer_group_name ==
               "some updated allow_access_customer_group_name"
      ...
      assert product.apply_quantity_discount_to_options ==
               "some updated apply_quantity_discount_to_options"
      ...
      assert product.group_options_for_quantity_pricing ==
               "some updated group_options_for_quantity_pricing"

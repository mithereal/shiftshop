defmodule Api.SwiftshopTest do
  ...
  describe "customer" do
    ...
    @invalid_attrs %{additional_field_3: nil, shipping_last_name: nil, shipping_address_2: nil, additional_field_2: nil, reset_password: nil, billing_address_2: nil, shipping_address_1: nil, enabled: nil, billing_taxid: nil, billing_company: nil, total_store_credit: nil, non_taxable: nil, billing_country: nil, shipping_zipcode: nil, additional_field_1: nil, shipping_state: nil, billing_first_name: nil, shipping_address_type: nil, customer_id: nil, billing_city: nil, shipping_first_name: nil, shipping_country: nil, password: nil, billing_zip_code: nil, shipping_phone_number: nil, billing_phone_number: nil, customer_group_id: nil, mail_list: nil, shipping_company: nil, billing_last_name: nil, email: nil, billing_state: nil, shipping_city: nil, comments: nil, billing_address_1: nil, disable_billing_same_as_shipping: nil}

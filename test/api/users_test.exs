defmodule Api.UsersTest do
  ...
  alias Api.Users.{User, UserToken}
  ...
  describe "users" do
    ...
    @invalid_attrs %{email: nil, github_id: nil, hashed_password: nil, id: nil, image: nil, shift4shop_id: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{email: "some email", github_id: "some github_id", hashed_password: "some hashed_password", id: "7488a646-e31f-11e4-aace-600308960662", image: "some image", shift4shop_id: "some shift4shop_id"}
      ...
      assert user.shift4shop_id == "some shift4shop_id"
    end
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{email: "some updated email", github_id: "some updated github_id", hashed_password: "some updated hashed_password", id: "7488a646-e31f-11e4-aace-600308960668", image: "some updated image", shift4shop_id: "some updated shift4shop_id"}
      ...
      assert user.shift4shop_id == "some updated shift4shop_id"
    end
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{email: "some email", github_id: "some github_id", hashed_password: "some hashed_password", id: "7488a646-e31f-11e4-aace-600308960662", shift4shop_id: "some shift4shop_id"}
